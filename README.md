...
<p align="center">
  <!-- Animated Badges with Pulse & Glow Effects -->
  <a href="#">
    <img src="https://img.shields.io/badge/version-1.0-blue?style=for-the-badge&logo=github&logoColor=white&color=00f0ff&labelColor=05040a" alt="Version">
  </a>
  <a href="#">
    <img src="https://img.shields.io/badge/platform-web-brightgreen?style=for-the-badge&logo=html5&logoColor=white&color=00f0ff&labelColor=05040a" alt="Platform">
  </a>
  <a href="#">
    <img src="https://img.shields.io/badge/license-MIT-green?style=for-the-badge&logo=opensourceinitiative&logoColor=white&color=ff0055&labelColor=05040a" alt="License">
  </a>
  <a href="#">
    <img src="https://img.shields.io/badge/V2Ray-Splitter-purple?style=for-the-badge&logo=v2ray&logoColor=white&color=00f0ff&labelColor=05040a" alt="V2Ray Splitter">
  </a>
  <a href="#">
    <img src="https://img.shields.io/badge/status-stable-success?style=for-the-badge&logo=statuspage&logoColor=white&color=39ff14&labelColor=05040a" alt="Status">
  </a>
  <a href="#">
    <img src="https://img.shields.io/badge/cyber-tool-8B5CF6?style=for-the-badge&logo=matrix&logoColor=white&color=00f0ff&labelColor=05040a" alt="Cyber Tool">
  </a>
</p>
<!-- Animated Divider -->
<p align="center">
...
- کانفیگ‌ها را بر اساس **امتیاز کیفیت** (نوع پروتکل، امنیت، پورت، ترانسپورت) مرتب‌سازی کنید.
- خروجی نهایی را با **تگ دلخواه** شخصی‌سازی کرده و کپی یا دانلود کنید.
همه‌ی پردازش‌ها در مرورگر شما انجام می‌شود و **هیچ داده‌ای به سرور ارسال نمی‌شود**.
---
### ✨ ویژگی‌های کلیدی

| دسته‌بندی | قابلیت‌ها |
| :--- | :--- |
| **⚡ موتور استخراج** | دریافت هم‌زمان از ۵۰+ منبع معتبر، پشتیبانی از لینک‌های سابسکریپشن، متن خام و فایل‌های متنی |
...
---
### 🧠 موتور پردازش (چطور کار می‌کند؟)
1. **دریافت داده**: ابزار ابتدا داده‌های ورودی را بررسی می‌کند. در صورت خالی بودن، از **۵۰+ منبع پیش‌فرض** استفاده می‌کند. در صورت وجود ورودی، لینک‌های HTTP/HTTPS را شناسایی و دریافت می‌کند و متن خام را نیز پردازش می‌کند.
2. **رمزگشایی**: داده‌های Base64 را شناسایی و رمزگشایی می‌کند تا کانفیگ‌های مدفون در آن‌ها را استخراج کند.
3. **استخراج URI**: با استفاده از رجکس‌های پیشرفته، تمام URIهای V2Ray (vmess://، vless://، trojan://، ss://، hysteria://، hysteria2://) را استخراج می‌کند.
4. **امتیازدهی**: هر کانفیگ را بر اساس پارامترهای زیر امتیازدهی می‌کند:
   - **پروتکل**: VLESS (۲۵+)، Hysteria2 (۲۰+)، Trojan (۱۵+)، VMess (۱۰+)
   - **امنیت**: Reality (۳۰+)، TLS/XTLS (۲۰+)
   - **ترانسپورت**: gRPC، XHTTP، SplitHTTP، WS (۱۵+)
...
5. روی **Save** کلیک کنید. پس از چند دقیقه، ابزار روی آدرس `https://matinejlali5-cell.github.io/<repo-name>/` در دسترس خواهد بود.
---
### 📄 مجوز
...
<p align="center">
  ...
  <a href="https://github.com/matinejlali5-cell">
    <img src="https://img.shields.io/badge/GitHub-matinejlali5--cell-181717?style=for-the-badge&logo=github&logoColor=white&labelColor=05040a" alt="GitHub">
  </a>
</p>
> **توسعه‌دهنده**: Mohammad Matin Ejlali  
> با تشکر ویژه از استاد گرامی **Hasan**  
> راه‌های ارتباطی:  
> 📱 [تلگرام](https://t.me/Mr_Matin_official)  
> 🌐 [گیت‌هاب](https://github.com/matinejlali5-cell)
---
<!-- ============================================================ -->
<!--                    English                                    -->
<!-- ============================================================ -->
...
- Rank configs using a **quality scoring** system (protocol type, security, port, transport).
- Customise the final output with a **personalised remark tag**.
- Copy or download the final result with one click.
...
| Category | Features |
| :--- | :--- |
| **⚡ Extraction Engine** | Simultaneous fetching from 50+ sources, support for subscription links, raw text, and file uploads |
...
---
### 🧠 Processing Engine (How it Works)
1. **Data Ingestion**: The tool first checks the input data. If empty, it uses **over 50 default sources**. If input is provided, it identifies HTTP/HTTPS links and fetches them, while also processing raw text.
2. **Decoding**: Identifies and decodes Base64‑encoded data to extract hidden configs.
3. **URI Extraction**: Using advanced regex patterns, it extracts all V2Ray URIs (vmess://, vless://, trojan://, ss://, hysteria://, hysteria2://).
4. **Scoring**: Each config is scored based on:
   - **Protocol**: VLESS (+25), Hysteria2 (+20), Trojan (+15), VMess (+10)
   - **Security**: Reality (+30), TLS/XTLS (+20)
   - **Transport**: gRPC, XHTTP, SplitHTTP, WS (+15)
...
5. Click **Save**. After a few minutes, the tool will be live at `https://matinejlali5-cell.github.io/<repo-name>/`.
---
### 📄 License
...
> **Developer**: Mohammad Matin Ejlali  
> Special thanks to respected professor **Hasan**  
> Official contact channels:  
> 📱 [Telegram](https://t.me/Mr_Matin_official)  
> 🌐 [GitHub](https://github.com/matinejlali5-cell)
